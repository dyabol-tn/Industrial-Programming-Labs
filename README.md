...
- [Laboratory Work 3 (проект)](#лабораторная--3-проект)
- [Laboratory Work 4 (проект)](#лабораторная--4-проект)
...
# Лабораторная № 4 (проект)

## Паттерны

### Общее задание:

Для предыдущей лабораторной реализовать один из паттернов:
1. Для записи данных в разные форматы, реализовать с Decorator Pattern.
Cмотреть тут: https://refactoring.guru/ru/design-patterns/decorator.
2. Реализовать Builder Pattern (https://refactoring.guru/ru/design-patterns/builder):
абстрактный класс/интерфейс, должен определять все этапы(объявляются
абстрактно), необходимые для производства сложного объекта-продукта и т.д.
реализовать функции (шаги сборки продукта на фабрике, согласно варианту если
необходимо).
